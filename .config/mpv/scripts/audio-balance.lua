...
local function update_filter()
	local graph = {}
	local channels = opts.forcelayout ~= "" and opts.forcelayout
		or mp.get_property("audio-params/hr-channels", "stereo")
	...
	if
		channels == "3.0"
		or channels == "3.0(back)"
		or channels == "3.1"
		or channels == "5.0"
		or channels == "5.0(side)"
		or channels == "4.1"
		or channels == "5.1"
		or channels == "5.1(side)"
		or channels == "6.0"
		or channels == "6.0(front)"
		or channels == "hexagonal"
		or channels == "6.1"
		or channels == "7.0"
		or channels == "7.0(front)"
		or channels == "7.1"
		or channels == "7.1(wide)"
		or channels == "7.1(side-side)"
		or channels == "octagonal"
	then
		graph[#graph + 1] = "FC=FC"
	end
...
mp.add_key_binding(")", "balance-to-left", function()
	change_balance(-0.05)
end, { repeatable = true })
mp.add_key_binding("=", "balance-to-right", function()
	change_balance(0.05)
end, { repeatable = true })
