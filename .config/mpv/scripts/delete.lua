...
function contains_item(l, i)
	for k, v in pairs(l) do
		if v == i then
			mp.osd_message(string.format("🗃️ Undeleting current file..........."), 5)
			l[k] = nil
			return true
		end
	end
	mp.osd_message(string.format("🗃️ Deleting current file........"), 5)
	return false
end
...
function delete()
	for i, v in pairs(del_list) do
		print("Deleting the file : " .. v)
		os.remove(v)
	end
end

mp.add_key_binding("ctrl+d", "delete_file", mark_delete)
