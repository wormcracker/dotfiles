...
local user_opts = {
    ...
    seekbarHeight = 18,
    controlsHeight = 44,
    smallButtonSize = 32, -- controlsHeight * 2/3
    trackButtonSize = 26, -- controlsHeight / 2
    buttonTooltipSize = 10,
    windowBarHeight = 34,
    windowButtonSize = 34,
    windowTitleSize = 14,
    cacheTextSize = 10,
    timecodeSize = 17,
    seekbarTimestampSize = 20,
    seekbarTimestampOutline = 2,
    chapterTickSize = 5,
    windowTitleOutline = 2,
